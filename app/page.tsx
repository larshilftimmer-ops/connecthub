...
export default function Home() {
  ...
  <>
    ...
    <div className="grid grid-cols-2 gap-4 mt-8">
      <button onClick={() => setActivePage("profile")} className="bg-zinc-900 p-5 rounded-3xl text-left">
        <div className="text-3xl mb-2">👤</div>
        <h3 className="font-bold">Profil</h3>
        <p className="text-gray-400 text-sm">Daten bearbeiten</p>
      </button>

      <button onClick={() => setActivePage("courses")} className="bg-zinc-900 p-5 rounded-3xl text-left">
        <div className="text-3xl mb-2">🎵</div>
        <h3 className="font-bold">Kurse</h3>
        <p className="text-gray-400 text-sm">Musikkurse ansehen</p>
      </button>

      <button onClick={() => setActivePage("schedule")} className="bg-zinc-900 p-5 rounded-3xl text-left">
        <div className="text-3xl mb-2">📅</div>
        <h3 className="font-bold">Stundenplan</h3>
        <p className="text-gray-400 text-sm">Unterricht & Termine</p>
      </button>

      <button onClick={() => setActivePage("instruments")} className="bg-zinc-900 p-5 rounded-3xl text-left">
        <div className="text-3xl mb-2">🎹</div>
    ...
    <p className="text-gray-400 mt-6">{user.email}</p>
    <p className="text-green-400">Rolle: admin</p>
